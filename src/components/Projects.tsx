      ...
      const projects: Project[] = [
            {
                  ...
                  caseStudy: {
                        overview: `For my graduation internship at Logichainge, I designed and implemented AddressID — a module that reduces address errors and speeds up order intake for logistics providers. It plugs into Logichainge’s existing Order Entry Module and can run stand-alone. The goals were to merge inconsistent addresses, prevent duplicates and let the logistics experts validate addresses quickly and prepare shipments for delivery.`,
